...
router.get('/:slug/activities', authMiddleware, requireEventRole(['ORGANIZER', 'MANAGER']), EventActivityController.list);
...
router.post('/:slug/scan', authMiddleware, requireEventRole(['ORGANIZER', 'MANAGER']), ActivityLogController.scan);
router.get('/:slug/scan/logs', authMiddleware, requireEventRole(['ORGANIZER', 'MANAGER']), ActivityLogController.listLogs);
router.get('/:slug/scan/stats', authMiddleware, requireEventRole(['ORGANIZER', 'MANAGER']), ActivityLogController.getStats);
