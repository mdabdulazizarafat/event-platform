...
export function corsMiddleware(req: Request, res: Response, next: NextFunction) {
  const allowedOriginsEnv = process.env.CORS_ORIGIN || 'https://somavesh.com,https://www.somavesh.com,https://Somavesh.rongplan.com,http://localhost:5173,http://localhost:3000';
