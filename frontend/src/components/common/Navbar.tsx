...
export default function Navbar() {
  ...
  return (
    <header
      id="navbar"
      className={`fixed top-0 right-0 left-0 z-[100] transition-[padding,background-color,backdrop-filter] duration-300 ${isCompact ? 'navbar-glass py-3' : 'bg-transparent py-5'
        }`}
    >
