...
export const metadata = {
  title: 'Terms & Conditions | Rong Plan',
  description: 'Terms and conditions for using Rong Plan services.',
};
    ...
    <div className="min-h-screen bg-background pt-24 pb-16">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <article className="prose prose-slate prose-lg max-w-none text-on-surface-variant font-sans">
          <p>
            Welcome to <strong>Rong Plan</strong>. These Terms and Conditions govern your use of our website and services. By accessing or using our platform, you agree to be bound by these terms.
          </p>
          ...
          <p>
            If you are an organizer hosting an event through Rong Plan:
          </p>
          <ul className="list-disc pl-6 space-y-2 mb-6">
            ...
            <li>Rong Plan is not responsible for the execution, quality, or safety of any event hosted on our platform.</li>
          </ul>

          <h2 className="text-2xl font-bold text-[#0a2540] mt-10 mb-4">4. Purchasing Tickets (Attendees)</h2>
          <p>
            If you are purchasing a ticket through Rong Plan:
          </p>
          <ul className="list-disc pl-6 space-y-2 mb-6">
            ...
            <li>Refund policies are set by the individual Event Organizers. Rong Plan does not issue refunds unless directed by the Organizer or required by law.</li>
          </ul>

          <h2 className="text-2xl font-bold text-[#0a2540] mt-10 mb-4">5. Intellectual Property</h2>
          <p>
            All content, features, and functionality on the platform (including text, graphics, logos, and software) are owned by Rong Plan and are protected by international copyright, trademark, and other intellectual property laws.
          </p>

          <h2 className="text-2xl font-bold text-[#0a2540] mt-10 mb-4">6. Limitation of Liability</h2>
          <p>
            In no event shall Rong Plan, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.
          </p>
